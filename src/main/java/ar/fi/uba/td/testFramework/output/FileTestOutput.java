...
/**
 * Class that extends from TestOutput use to write the result on a file.
 */
...
public class FileTestOutput extends TestOutput {
    ...
    public void endTestCaseOutput(String testName, TestStatus testStatus,
	    long runTime) {
	this.output.add(testStatus.toString() + " " + testName + " time: "
	...
	try {
	    ...
	    writeBuffer
		    .write("----------------------------------------------\n");
	    writeBuffer
		    .write("Run: " + testResults.getNumberOfTestRun() + "\n");
